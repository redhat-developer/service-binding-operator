...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BindingReferenceType) DeepCopyInto(out *BindingReferenceType) {
	*out = *in
	out.GroupVersionKind = in.GroupVersionKind
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BindingReferenceType.
func (in *BindingReferenceType) DeepCopy() *BindingReferenceType {
	if in == nil {
		return nil
	}
	out := new(BindingReferenceType)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceBindingRequestSpec) DeepCopyInto(out *ServiceBindingRequestSpec) {
	*out = *in
	if in.BindingReferenceType != nil {
		in, out := &in.BindingReferenceType, &out.BindingReferenceType
		*out = new(BindingReferenceType)
		**out = **in
	}
