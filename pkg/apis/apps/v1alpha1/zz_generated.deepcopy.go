...
func (in *BindingPath) DeepCopyInto(out *BindingPath) {
	*out = *in
	...
	if in.CustomSecretPath != nil {
		in, out := &in.CustomSecretPath, &out.CustomSecretPath
		*out = new(string)
		**out = **in
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodSpecPath) DeepCopyInto(out *PodSpecPath) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodSpecPath.
func (in *PodSpecPath) DeepCopy() *PodSpecPath {
	if in == nil {
		return nil
	}
	out := new(PodSpecPath)
