...
//	if sbr.Spec.Application.ResourceRef == "" &&
...
func (r *Reconciler) getServiceBinding(
	...
	gr := v1alpha1.SchemeGroupVersion.WithResource(ServiceBindingResource)
...
// extractServiceSelectors returns a list of all services items from a
// ServiceBinding.
//
// NOTE(isuttonl): remove this method when spec.services is deprecated
func extractServiceSelectors(
	sbr *v1alpha1.ServiceBinding,
) []v1alpha1.Service {
	return sbr.Spec.Services
}
...
func (r *Reconciler) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	if len(selectors) == 0 {
		...
		_, updateErr := updateServiceBindingStatus(r.dynClient, sbr)
		if updateErr == nil {
			return Done()
		}
