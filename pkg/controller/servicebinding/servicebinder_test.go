...
func TestServiceBinder_Bind(t *testing.T) {
			...
			Services: []v1alpha1.Service{
				{
					...
					LocalObjectReference: corev1.LocalObjectReference{Name: db1.GetName()},
				},
			},
		},
	...
	sbrSingleServiceWithCustomEnvVar := &v1alpha1.ServiceBinding{
		...
		ObjectMeta: metav1.ObjectMeta{
			Name: "single-sbr-with-dataMapping",
		},
		Spec: v1alpha1.ServiceBindingSpec{
			Application: v1alpha1.Application{
				LabelSelector: &metav1.LabelSelector{
		...
		Spec: v1alpha1.ServiceBindingSpec{
			...
			Services: []v1alpha1.Service{
				...
				},
				{
					...
					LocalObjectReference: corev1.LocalObjectReference{Name: db2.GetName()},
				},
			},
		},
		Status: v1alpha1.ServiceBindingStatus{},
	...
	sbrEmptyBackingServiceSelector := &v1alpha1.ServiceBinding{
		TypeMeta: metav1.TypeMeta{
			APIVersion: "operators.coreos.com/v1alpha1",
			Kind:       "ServiceBinding",
		},
